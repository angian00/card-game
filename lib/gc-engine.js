...
function GameStatus() {
	...
	this.attack = function(attIndex, targetIndex) {
		...
		if ( (!target.hasMechanics(Mechanics.TAUNT)) && 
			this.otherPlayer.board.cards.some(c => c.hasMechanics(Mechanics.TAUNT)) ) {

			this.message = "Some other minion has Taunt";
			return null;
		}
